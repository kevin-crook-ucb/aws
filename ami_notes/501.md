...
Amazon has always cited difficulty in providing this as the reason when I've asked their tech support.  After spending considerable time and trying numerous packages, I have a great appreciation for the difficulty.  

It's really easy to get a Linux desktop to come up on AWS and look like it's working at first glance.  You can even use them for a few minutes for trivial things. 

However, when you start using it for real things, it quickly becomes apparent that it's extremely buggy and won't run up to production standards.  The dreaded "black screens of death", "grey screens of death", and "X resource xxxx not found" error messages don't take long to rear their ugly heads.  Plus the wonderfully specific error messages such as "X xxxx has been terminated due to unknown error..."

Linux desktops seems to work really well on "real computers" such as your laptop or desktop, and on virtual machines on real computers, but are just the opposite in AWS. 





My attempt here is create an AMI that allows a Linux desktop. 
